...
export default function PostInterviewSummary({
  ...
  // Use the latest metrics and provide default values for required fields
  ...
  const metrics = {
    ...
    technicalAccuracy: latestMetrics.accuracy ?? 0,
    communication: 80, // default or calculated value
    timeManagement: 75, // default or calculated value
  };
